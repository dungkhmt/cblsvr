...
public class MinMaxCVRP2NeighborhoodsWithTotalCost extends MinMaxCVRP {
	...
	public static void run(String fi, String fo, int timeLimit){
		try{
			MinMaxCVRP2NeighborhoodsWithTotalCost vrp = new MinMaxCVRP2NeighborhoodsWithTotalCost();
			vrp.readData(fi);
			vrp.mapping();
			vrp.stateModel();
