...
public class GreedyOneRequestMoveExplorerLimit implements INeighborhoodExplorer {
	...
	public GreedyOneRequestMoveExplorerLimit(VarRoutesVR XR, LexMultiFunctions F, int K, ArrayList<Point>pickup, ArrayList<Point> delivery) {
		this.XR = XR;
		this.F = F;
	...
	public GreedyOneRequestMoveExplorerLimit(VarRoutesVR XR, LexMultiFunctions F,double p, int K, ArrayList<Point>pickup, ArrayList<Point> delivery) {
		this.XR = XR;
		this.F = F;
		this.mgr = XR.getVRManager();
		this.K = K;
