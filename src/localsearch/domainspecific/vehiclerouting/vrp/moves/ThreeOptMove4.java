...
public class ThreeOptMove4 implements IVRMove {
	...
	public ThreeOptMove4(VRManager mgr, LexMultiValues eval, Point x, Point y, Point z, INeighborhoodExplorer NE){
		this.mgr = mgr;
		this.eval = eval;
		this.x = x;
		this.y = y;
	...
	public ThreeOptMove4(VRManager mgr, LexMultiValues eval, Point x, Point y, Point z){
		this.mgr = mgr;
		this.eval = eval;
		this.x = x;
		this.y = y;
