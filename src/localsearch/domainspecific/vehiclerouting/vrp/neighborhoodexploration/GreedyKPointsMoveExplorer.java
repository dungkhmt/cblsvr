...
import java.util.*;
public class GreedyKPointsMoveExplorer implements INeighborhoodExplorer {
	...
	public GreedyKPointsMoveExplorer(VarRoutesVR XR, LexMultiFunctions F, int K, HashSet<Point> mandatory) {
		this.XR = XR;
		this.F = F;
