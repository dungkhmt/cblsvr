...
public class Eq implements IConstraintVR {
	private IConstraintVR cstr;
	
	public Eq(IFunctionVR f, double c){
		cstr = new EqConstantFunction(c,f);
	}
	public Eq(double c, IFunctionVR f){
		cstr = new EqConstantFunction(c,f);
	}
	public Eq(IFunctionVR f1, IFunctionVR f2){
		cstr = new EqFunctionFunction(f1,f2);
	}
	...
	public void propagateAddTwoPoints(Point x1, Point y1, Point x2, Point y2) {
		// TODO Auto-generated method stub
		System.out.println("Eq::propagateAddTwoPoints HAS NOT BEEN IMPLEMENTED YET");
		System.exit(-1);
	}

	public void propagateRemoveTwoPoints(Point x1, Point x2) {
		// TODO Auto-generated method stub
		System.out.println("Eq::propagateRemoveTwoPoints HAS NOT BEEN IMPLEMENTED YET");
		System.exit(-1);
	}
